...
<script language="JavaScript">
	...
	function create_window (image, width, height) {
		...
		var specs = "location=no, scrollbars=no, directories=no, menubars=no, toolbars=no, resizable=yes, left=0, top=0, width=" + width + ", height=" + height;
		
		// Set the URL:
		var url = "show_photo.php?photo_id=" + image;
