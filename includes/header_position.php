...
document.getElementById("pm_cancel").onclick=function(){
	//alert("cancel button clicked");
	//document.getElementById("pmform").style.display="none";
	document.getElementById("pmform").style.left="0%";
	document.getElementById("pmform").style.marginLeft="0px";
	
}
//document.getElementById("pm_submit").onclick= function(){
	//alert("hello stay open");
	//document.getElementById("pmform").style.display="block";
	//document.location="messages.php";
	//document.getElementById("pmform").style.left="50%";
	//document.getElementById("pmform").style.marginLeft="-227px";
	//document.getElementById("pmform").style.backgroundColor="red";
//}

}//end of set link function
...
//document.getElementById("closeBtn").onclick=closePMContainer();
  ...
  <form action="<?php if(!empty($pm_errors)){ echo "messages2.php"; }?>" method="post" name="pmform" id="pmform">
...
?>
    ...
    <p id="buttons_para" >
      <input type="submit" name="pm_submit" value="Send" id="pm_submit" onclick="<?php if(!empty($pm_errors)){ echo "pmform_stayopen()";} ?>"/>
      <input type="button" name="pm_cancel" value="Cancel" id="pm_cancel" onclick="closePMForm2()"; />
    </p>
  </form>
  <!--end of the form-->
</div>
