	...
	//*********************************************************************************************************************	
		...
		if(mysqli_num_rows($rf)>0){
			while($row=mysqli_fetch_assoc($rf)){
				//echo $row['user_id'];
				if(!$row['avatar']){
					//echo "<p>Mysterious Ally</p>";;
					echo "<p  ><a href='messages.php?user_id=".$row['friend_id']."' ><img src='images_profiles/noimage.jpg' class='friend_small' width='60' height='60'></a></p>";
				}else{
					//echo $row['name'];
				echo "<p ><a href='messages.php?user_id=".$row['friend_id']."' ><img src='images_profiles/".$row['avatar']." ' width='60' height='60' class='friend_small'/></a></p>";
				}
			}
