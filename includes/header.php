...
echo '<li><a href="messages.php?user_id='.$user_id. '" >Posts</a></li>';
...
if (isset($_SESSION['user_id'])){
	...
	if(mysqli_num_rows($r) > 0){
		...
		if(!isset($_GET['user_id']) || $_GET['user_id']==$_SESSION['user_id']){
		echo "<p><a href='photo_upload.php?user_id=".$row['user_id']."' >Manage Photos</a></p>";
	...
	//*********************************************************************************************************************	
		...
		if(isset($_SESSION['user_id'])||!isset($_GET['user_id'])){//july27 add isset session user_id
		echo "<p>&#160;</p>
	...
	echo "You have not registered/or login yet!";
}
?>
  </div>
