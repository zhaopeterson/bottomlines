	...
	if(mysqli_num_rows($result_lm)>0){
		...
		//----------------------------------------------------------------------------------------------------------------	
			//----------------------------------------------------------------------------------------------------------------
				//----------------------------------------------------------------------------------------------------------------
				//add link to 
			echo "<p><img src='profile_uploads/".$row['tmp_name']."  ' class='avatar_small' width='30' height='30' /> on ".$row['pm_send']." to ".$row['first_name']."<br/><a href='display_pm.php?pmtid=".$row['pmthread_id']."'>".$row['pm_body']. "</a></p>";
